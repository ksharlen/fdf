...
/*   Updated: 2019/10/30 21:57:04 by ksharlen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define DFLT_P			0
# define P_ZOOM_UP 		0
# define P_ZOOM_DOWN 	40

# define P_MOV_UP 		80
# define P_MOV_DOWN 	120
...
void	fdf_menu(t_mlx *mlx)
{
	...
	mlx_string_put(MLX_PTR, MLX_WIN, DFLT_P, FDF_P_RESET_IMG, COLOR, FDF_RESET_IMG);
}
