...
#define XK_Escape                        53
#define XK_Delete                        51  /* Delete, rubout */

/* 0xff31 thru 0xff3f are under XK_KOREAN */

/* Cursor control & motion */

#define XK_Left                          123  /* Move left, left arrow */
#define XK_Up                            126  /* Move up, up arrow */
#define XK_Right                         124  /* Move right, right arrow */
#define XK_Down                          125  /* Move down, down arrow */

/* Keypad functions, keypad numbers cleverly chosen to map to ASCII */

#define XK_KP_Space                      49  /* Space */
#define XK_KP_Tab                        48
#define XK_KP_Enter                      76  /* Enter */
#define XK_KP_F1                         122 /* PF1, KP_A, ... */
#define XK_KP_F2                         120
#define XK_KP_F3                         99
#define XK_KP_F4                         119
#define XK_KP_Delete                     51f
